    ...
    public class init_app : Renga.IPlugin
    {
        ...
        public bool Initialize(string pluginFolder)
        {
            ...
            /*Кнопка для запуска диалогового окна для подготовки проекта и его валидации для пригодности начала работы с плагином
                ...
                1. Выбор текстового файла сопоставления идентификаторов пользователей с разрешенными разделами проектирования для них;
            ...
            follow_application.ProjectClose += (object sender, Renga.ProjectCloseEventArgs args) =>
            {
